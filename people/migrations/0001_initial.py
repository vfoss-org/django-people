# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2016-12-13 05:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=b'default', max_length=256, verbose_name='Name')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('long_biography', models.TextField(blank=True, max_length=512, verbose_name='Short Biography')),
                ('short_biography', models.TextField(blank=True, max_length=2000, verbose_name='Biography')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordering', models.PositiveIntegerField(blank=True, null=True, verbose_name='Ordering')),
                ('biography', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='person_biography', to='people.Biography', verbose_name='Biography')),
